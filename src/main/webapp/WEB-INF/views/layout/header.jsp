<nav class="navbar page-header">
	<a href="#"
		...
		class="fa fa-bars"></i>
	</a> <a class="navbar-brand" href="#"> <img src="${pageContext.request.contextPath}/resources/app/imgs/logo.png"
		alt="logo">
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			aria-expanded="false"> <img src="${pageContext.request.contextPath}/resources/app/imgs/avatar-1.png"
			...
			<div class="dropdown-menu dropdown-menu-right">
				...
				<a href="#" class="dropdown-item"> <i class="fa fa-bell"></i>
					...
					Settings
				</a> <a href="${pageContext.request.contextPath}/logout" class="dropdown-item"> <i class="fa fa-lock"></i>
					Logout
				</a>
			</div></li>
	</ul>
